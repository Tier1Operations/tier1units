...
DEBUGLOG format ["EDIT ADJUST IMPACT POS EVENT START | _this: %1", _this];

private _nr = ctrlText _displayorcontrol;
if (_nr == "") exitWith {};

DEBUGLOG format ["EDIT ADJUST IMPACT POS EVENT 1 | _nr: %1", _nr];

_nr = [_nr] call T1AM_Fnc_GridToPos;
_nr = [_nr, 5, true] call T1AM_Fnc_ParseNumber;

DEBUGLOG "EDIT ADJUST IMPACT POS EVENT 2";
...
DEBUGLOG format ["EDIT ADJUST IMPACT POS EVENT 3 | _nr: %1", _nr];
...
DEBUGLOG format ["EDIT ADJUST IMPACT POS EVENT END | T1AM_LastAdjustImpactX: %1 | T1AM_LastAdjustImpactY: %2", T1AM_LastAdjustImpactX, T1AM_LastAdjustImpactY];