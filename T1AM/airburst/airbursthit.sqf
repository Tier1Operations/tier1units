// Called from T1AM\Airburst\AirburstFire2.sqf
...
nul = [_airburstLocationASL,_concentration,_effectiveRange,_maxRange,_falloff] execVM "T1AM\Airburst\CallShrapnel.sqf";