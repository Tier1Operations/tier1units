...
class CfgFunctions
{
	class T1AM
	{
		class Functions
		{
			...
			class LoadMagazine {file = "T1AM\Misc\LoadMagazine.sqf"};
			...
			class SetAudio {file = "T1AM\Misc\SetAudio.sqf"};
			...
			class GetDirection {file = "T1AM\Misc\GetDirection.sqf"};
			class GroupVehicles {file = "T1AM\Misc\GroupVehicles.sqf"};
			class ArtilleryAmmoCheck {file = "T1AM\Misc\ArtilleryAmmoCheck.sqf"};
			...
			class DebugStart {file = "T1AM\Test\DebugStart.sqf"};
			class ProjectileTrack {file = "T1AM\Test\ProjectileTrack.sqf"};
			class ProjectileTrail {file = "T1AM\Test\ProjectileTrail.sqf"};
		};
	};
