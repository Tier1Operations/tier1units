...
private _x = [ctrlText 204, 0] call T1AM_Fnc_ParseNumber;

// Y adjustment (up/down)
private _y = [ctrlText 205, 0] call T1AM_Fnc_ParseNumber;
...
((findDisplay 200) displayCtrl 204) ctrlSetText format ["%1",0];
((findDisplay 200) displayCtrl 205) ctrlSetText format ["%1",0];
T1AM_LastAdjustX = 0;
T1AM_LastAdjustY = 0;
[] spawn {
	sleep 1;
