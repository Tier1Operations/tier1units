...
//DIAG_LOG format["AIMPOINT MAPCLICK -- POS BEFORE RANDOM: %1", [T1AM_X,T1AM_Y,T1AM_Elevation]];
...
if (_initialMiss) then {
	...
	//DIAG_LOG format["AIMPOINT MAPCLICK -- POS AFTER RANDOM: %1", [T1AM_X,T1AM_Y,T1AM_Elevation]];
};
