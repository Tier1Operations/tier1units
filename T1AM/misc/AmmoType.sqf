...
switch (_ammo) do {
	...
	case ("8Rnd_82mm_Mo_LG") : {_out = "HE"};
	case ("8Rnd_82mm_Mo_guided") : {_out = "HE"};
	
	// Sholef
	case ("32Rnd_155mm_Mo_shells") : {_out = "HE"};
	case ("6Rnd_155mm_Mo_smoke") : {_out = "SMOKE"};
	case ("2Rnd_155mm_Mo_guided") : {_out = "AT"};
	case ("2Rnd_155mm_Mo_cluster") : {_out = "CLUST. HE"};
	case ("2Rnd_155mm_Mo_lg") : {_out = "HE/AT"};
	...
	case ("2Rnd_155mm_Mo_guided_O") : {_out = "AT"};
	case ("2Rnd_155mm_Mo_Cluster_O") : {_out = "CLUST. HE"};
	case ("4Rnd_155mm_Mo_LG_O") : {_out = "HE/AT"};
	...
	case ("rhs_mag_155mm_m712_2") : {_out = "AT"};
	...
	case ("rhs_mag_LASER_2a33") : {_out = "AT"};
