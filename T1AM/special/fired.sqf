...
_doAirburst = _infoDummy getVariable ["T1AM_doAirburst", false];
...
if (_action == 1 or {_action == 2} or {_action == 3} or {_action == 4}) exitWith {nul = [_firedEHArray,_pos,_gunAngle,_action,_fuse,_infoDummy,_doAirburst,_longRangeGuided,_arrayEnemySides,_GPSZAdjust,_elevationMod] execVM "T1AM\Special\Guided.sqf"};