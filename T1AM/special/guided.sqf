...
_unguidedCEP = _infoDummy getVariable ["T1AM_unguidedCEP", 85];
if (_action == 4) then {
...
nul = [_firedEHArray,_target,_projectile,_pos,_radius,_action,_fuse,_infoDummy,_doAirburst,_arrayEnemySides,_GPSZAdjust,_elevationMod,_unguidedCEP] execVM "T1AM\Special\GuideProjectile.sqf";
//DIAG_LOG "GUIDED - END";