 ...
 */
#define IV_CHANGE_PER_SECOND         ([41.66, 4.166] select (ace_medical_level >= 2))
...
if (!isNil {_unit getVariable "ace_medical_ivBags"}) then {
    if (_bloodVolume < 100) then {
        ...
        _bloodBags = _bloodBags apply {
            ...
            private _bagChange = (IV_CHANGE_PER_SECOND * 3) min _bagVolumeRemaining; // absolute value of the change in miliLiters
