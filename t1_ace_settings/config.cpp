class CfgPatches
{
	...
	{
		requiredaddons[] = {"ace_advanced_ballistics","ace_zeus","ace_vehiclelock","ace_vehicles","ace_viewdistance","ace_weaponselect","ace_weather","ace_winddeflection","ace_yardage450","ace_tripod","ace_ui","ace_vector","ace_switchunits","ace_tacticalladder","ace_testmissions","ace_thermals","ace_sandbag","ace_scopes","ace_sitting","ace_slideshow","ace_smallarms","ace_spottingscope","ace_ragdolls","ace_rangecard","ace_realisticnames","ace_recoil","ace_reload","ace_reloadlaunchers","ace_respawn","ace_safemode","ace_optics","ace_optionsmenu","ace_overheating","ace_overpressure","ACE_Parachute","ace_mx2a","ace_nametags","ace_nightvision","ace_noidle","ace_noradio","ace_norearm","ace_microdagr","ace_missileguidance","ace_missionModules","ace_mk6mortar","ace_modules","ace_movement","ace_medical","ace_magazinerepack","ace_main","ace_map","ace_maptools","ace_markers","ace_laser","ace_laser_selfdesignate","ace_laserpointer","ace_logistics_uavbattery","ace_logistics_wirecutter","ace_interact_menu","ace_interaction","ace_inventory","ace_javelin","ace_kestrel4500","ace_hearing","ace_hitreactions","ace_huntir","ace_frag","ace_gforces","ace_goggles","ace_grenades","ace_disposable","ace_dragging","ace_explosives","ace_fcs","ace_finger","ace_flashsuppressors","ace_concertina_wire","ace_dagr","ace_difficulties","ace_disarming","ace_captives","ace_common","ace_atragmx","ace_attach","ace_backpacks","ace_ballistics","ace_ai","ace_aircraft","ace_APL"};
		units[] = {};
		weapons[] = {};
		magazines[] = {};
	};
